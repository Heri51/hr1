...
if (isset($_POST['submit'])) {
  ...
  $result = mysqli_query($conn, "INSERT INTO karyawan SET nama='$nama',tgl_lahir='$tgl_lahir',gaji='$gaji'");

  if ($result) {
    $pesan = 'Selamat, data karyawan anda berhasil ditambahkan';
    $tipe = 'success';
    $redirect = 'data_karyawan.php';
  } else {
    $pesan = 'Maaf! data karyawan anda gagal ditambahkan';
    $tipe = 'error';
    $redirect = '';
  }
